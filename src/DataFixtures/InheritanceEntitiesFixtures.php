    ...
    public function load(ObjectManager $manager)
    {
        for ($i = 1; $i <= 2; $i++) {
            ...
            for ($j = 1; $j <= 10; $j++) {
                ...
                $video->setDescription('video description of user' . $i); // common elements of File
                ...
                $video->setDuration(123); //especific properties of video
                $video->setTitle("video " . $i); //especific properties of video
